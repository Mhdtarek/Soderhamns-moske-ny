        ...
        children: [
          ...
          FadeTransition(
            ...
            child: SlideTransition(
              ...
              child: Padding(
                padding: const EdgeInsets.symmetric(horizontal: 12),
                child: _LatestNewsCard(newsAsync: newsAsync),
              ),
            ),
          ),
        ],
...
class _LatestNewsCard extends ConsumerWidget {
  const _LatestNewsCard({required this.newsAsync});
...
class _NewsRow extends StatelessWidget {
  const _NewsRow({required this.post, required this.onTap});
